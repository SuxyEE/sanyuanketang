...
import GroupDiscussionPanel from '@/student-components/GroupDiscussionPanel.vue'
import AiChatDrawer from '@/student-components/AiChatDrawer.vue'
import NotesPanel from '@/student-components/NotesPanel.vue'
import SignInPopup from '@/student-components/SignInPopup.vue'
import AiInteractiveViewer from '@/student-components/AiInteractiveViewer.vue'
import AiWhiteboardViewer from '@/student-components/AiWhiteboardViewer.vue'
import PollPanel from '@/student-components/PollPanel.vue'
import AnswerWallPanel from '@/student-components/AnswerWallPanel.vue'
import DanmakuLayer from '@/student-components/DanmakuLayer.vue'
import ReactionBar from '@/student-components/ReactionBar.vue'
import ClassTimer from '@/student-components/ClassTimer.vue'
import PointsBadge from '@/student-components/PointsBadge.vue'
import { lockToCurrentApp, unlockApp } from '@/student-kiosk'
import { disableAntiExit, enableAntiExit, refreshFullscreenOnShow } from '@/composables/useAntiExit'
...
import Overlay from '@/student-components/ui/Overlay.vue'
...
function confirmLeaveClassroom() {
  uni.showModal({
    ...
    success: (res) => {
      ...
      setTimeout(() => navigateAwayFromClassroom('/pages/student/join/index'), 300)
    },
  })
}
...
onLoad((q: any = {}) => {
  ...
  if (!lessonId.value) {
    uni.redirectTo({ url: '/pages/student/join/index' })
  }
})
...
onMounted(() => {
  ...
  s.on(RoomEvent.JoinError, (data: { message?: string }) => {
    ...
    setTimeout(() => uni.redirectTo({ url: '/pages/student/join/index' }), 1200)
  })
  ...
  s.on(RoomEvent.LessonEnd, () => {
    ...
    store.competeResult = null
    setTimeout(() => {
      navigateAwayFromClassroom('/pages/student/after-class/index')
    }, 1500)
  })
